...
const BrowseTrailer = ({ videoUrl, isScroll }) => {
  return (
    ...
    <div className="w-screen lg:h-screen">
      <iframe
        className={`w-full h-full aspect-video overflow-x-hidden fixed left-[50%] -translate-x-1/2 -top-64 lg:top-0 scale-[1.65] opacity-${isScroll} transition-all duration-300`}
...
//   return (
//     // <div className="absolute -top-16 left-0 right-0  -z-20 max-w-[100vw] max-h-[100vh] overflow-hidden">
//     <div className=" -m-48  lg:h-[120vh]  -z-20 overflow-y-hidden">
//       <iframe
